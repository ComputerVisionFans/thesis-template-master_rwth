...
In Figure 3.1, we present our multi-scale AttentionNet architecture which adopts the YOLOV3-Tiny architecture as its fundamental building block in order to process more efficiently on small target. We follow the same
...
15                                 & Convolutional                & {\color[HTML]{CB0000} \textbf{18}}   & 1×1/1                & 13×13×512            & {\color[HTML]{CB0000} \textbf{13×13×18}} \\
16                                 & YOLO                         &                                      & \multicolumn{1}{c}{} & \multicolumn{1}{c}{} & \multicolumn{1}{c}{}                     \\
17                                 & \textit{\textbf{Rout13}}     &                                      &                      &                      &                                          \\
18                                 & Convolutional                & 128                                  & 1×1/1                & 13×13×256            & 13×13×128                                \\
19                                 & Up-sampling                  &                                      & 2×2/2                & 13×13×256            & 26×26×128                                \\
20                                 & \textit{\textbf{Route 19,8}} &                                      &                      &                      &                                          \\
21                                 & Convolutional                & 256                                  & 3×3/1                & 26×26×384            & 26×26×256                                \\
22                                 & Convolutional                & {\color[HTML]{CB0000} \textbf{18}}   & 1×1/1                & 26×26×256            & {\color[HTML]{CB0000} \textbf{26×26×18}} \\
23                                 & YOLO                         &                                      &                      &                      &                                          \\ \bottomrule

\end{tabular}}
\caption{\textbf{AttentionNet network structure}. $^{\mathrm{18}}$Final YOLO Output should equal to 3×(classes+5))}
\end{table}
...
\begin{figure}[htbp]
\centering
\subfigure[ $13 \times 13$, $26 \times 26$ tensor Cellyolo PR on val dataset]{
\begin{minipage}[t]{0.5\linewidth}
\centering
\includegraphics[width=2in]{2 tensor cellyolo PR on val dataset.png}
%\caption{fig1}
\end{minipage}%
}%


\subfigure[$52 \times 52$, $26 \times 26$tensor Cellyolo PR on val dataset]{
\begin{minipage}[t]{0.5\linewidth}
\centering
\includegraphics[width=2in]{52 tensor cellyolo PR on val dataset.png}
%\caption{fig2}
\end{minipage}
}%
\centering
...
\subsection[Awesome Figures in the TOC]
...
Nevertheless, there are the following three scale targets in the dataset: large‐scale targets,
moderate‐scale targets, and small‐scale targets [30]. The main steps of the K‐means++ method are as
follows:   
...
\begin{figure}[h]
	\begin{center}
		\begin{subfigure}[t]{0.49\textwidth}
		    \centering
			\includegraphics[height=6.5in]{res18.pdf}
			\caption{Overall architecture of ResNet18}
			\label{fig:res18}
		\end{subfigure}
		\begin{subfigure}[t]{0.49\textwidth}
		    \centering
			\includegraphics[height =6in]{Ghostres18.pdf}
...
\begin{figure}[h]
	\begin{center}
		\begin{subfigure}[b]{0.49\textwidth}
			\includegraphics[width=\textwidth]{normal conv.png}
			\caption{The normal Convolutional layer}
			\label{fig:res18}
		\end{subfigure}
		\begin{subfigure}[b]{0.49\textwidth}
		    \centering
			\includegraphics[width=\textwidth]{ghostmodule.png}
...
\begin{figure}[h]
	\begin{center}
		\begin{subfigure}[b]{0.49\textwidth}
			\includegraphics[width=3.5in]{stride1 module.png}
			\caption{Stride = 1 SE = 0 G-bneck}
			\label{fig:res18}
		\end{subfigure}
		\begin{subfigure}[b]{0.49\textwidth}
			\includegraphics[width=3.5in]{stride2 module.png}
...
\begin{figure}[h]
	\begin{center}
		\begin{subfigure}[b]{0.45\textwidth}
		    \centering
			\includegraphics[height= 0.10\textheight]{hd1 (4400).png}
			\caption{}
			\label{fig:res18}
		\end{subfigure}
		\begin{subfigure}[b]{0.45\textwidth}
		    \centering
			\includegraphics[height= 0.10\textheight]{hd1 (4400) (1).png}
			\caption{}
			\label{fig:cellnet}
		\end{subfigure}
		...
		\begin{subfigure}[b]{0.45\textwidth}
		    \centering
			\includegraphics[height= 0.10\textheight]{hd1 (4550).png}
			\caption{}
			\label{fig:cellnet}
		\end{subfigure}
		\begin{subfigure}[b]{0.45\textwidth}
		    \centering
			\includegraphics[height= 0.10\textheight]{hd1 (4550) (1).png}
			\caption{}
			\label{fig:cellnet}
		\end{subfigure}
		\begin{subfigure}[b]{0.45\textwidth}
		    \centering
			\includegraphics[height= 0.10\textheight]{ss2_8 (142).png}
			\caption{}
			\label{fig:cellnet}
		\end{subfigure}
		\begin{subfigure}[b]{0.45\textwidth}
		    \centering
			\includegraphics[height= 0.10\textheight]{ss2_8 (142) (1).png}
			\caption{}
			\label{fig:cellnet}
		\end{subfigure}
		...
		\begin{subfigure}[b]{0.33\textwidth}
		    \centering
			\includegraphics[height= 0.20\textheight]{hd1 (4550)ournetWithcellyolo.jpg}
			\caption{}
			\label{fig:cellnet}
		\end{subfigure}
		\begin{subfigure}[b]{0.33\textwidth}
		    \centering
			\includegraphics[height= 0.20\textheight]{hd1 (4550)resnetWithcellyolo.jpg}
			\caption{}
			\label{fig:cellnet}
		\end{subfigure}
		\begin{subfigure}[b]{0.33\textwidth}
		    \centering
			\includegraphics[height= 0.20\textheight]{hd1 (4550)vggnetWithcellyolo.jpg}
			\caption{}
			\label{fig:cellnet}
		\end{subfigure}
	\end{center}
...
\begin{figure}[h]
	\begin{center}
		\begin{subfigure}[b]{0.49\textwidth}
			\includegraphics[height= 0.25\textheight]{Inkedfirst Conv1 of resnet18 with pretrain weights on coviddataset_LI.jpg}
			\caption{}
			\label{fig:res18}
		\end{subfigure}
		...
		\begin{subfigure}[b]{0.49\textwidth}
			\includegraphics[height= 0.25\textheight]{Inkedfirst Conv1 of resnet18 with pretrain weights on penudataset_LI.jpg}
			\caption{}
			\label{fig:cellnet}
		\end{subfigure}
		
		\begin{subfigure}[b]{0.49\textwidth}
			\includegraphics[height= 0.25\textheight]{cellnetnecc3.jpg}
			\caption{}
			\label{fig:cellnet}
		\end{subfigure}
...
\begin{figure}[h]
\centering
\includegraphics[height=200pt, width=0.9\textwidth]{Cifar-12-06-2020.png}
\label{fig}
\centering
...
\begin{figure}[h]
\centering
\includegraphics[height=200pt, width=0.9\textwidth]{Pneumonia_TimeSeries-1.png}
\label{fig}
\centering
...
\begin{figure}[h]
\centering
\includegraphics[height=200pt, width=0.9\textwidth]{COVID-19_TimeSeries-1.png}
\label{fig}
\centering
...
\begin{figure}[h]
\includegraphics[height=240pt,width=0.9\textwidth]{BarDiagram_Bold.png}
\label{fig}
\centering
