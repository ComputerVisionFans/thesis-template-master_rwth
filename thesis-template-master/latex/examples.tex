...
\label{sub:amet}
scaling inhibiting vs intrinsic features map.} Squeeze-and-Excitation (SE)\cite{b24} adaptively recalibrates channel-wise feature responses by explicitly modeling inter-dependencies between channels. 
...
\section{Analysis on complexities and necessities} % (fold)
\label{sub:dolor_sit}
